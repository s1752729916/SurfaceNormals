...
class SurfaceDataset(Dataset):
    ...
    def __init__(self,  dolp_label,aolp_label,label_dir,dolp_dir,aolp_dir,mask_dir=None, transform=None, input_only=None):
    ...
    def _create_lists_filenames(self):
        ...
        # -- 5、verify number of every input
            if not (numDoLP==numNAoLP == numMasks == numLabels == numAolplabels ==numDolplabels):
