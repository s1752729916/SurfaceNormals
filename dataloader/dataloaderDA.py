...
class DASurfaceDataset(Dataset):
    """
    ...
    def __init__(self,  label_dir,dolp_dir,aolp_dir,mask_dir=None, transform=None, input_only=None):
    ...
    def _create_lists_filenames(self):
        ...
        # -- 5、verify number of every input
            if not (numDoLP==numNAoLP == numMasks == numLabels):
                ...
                raise ValueError('Numbers of inputs(dolp,aolp,label,mask) are different.')
