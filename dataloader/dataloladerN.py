...
class NSurfaceDataset(Dataset):
    ...
    def __init__(self,  label_dir,synthesis_normals_dir,mask_dir=None, transform=None, input_only=None):
    ...
    def __getitem__(self, index):
        ...
        input_img_arr = numpy.zeros([12, height, width], dtype=np.uint8)  # shape is (13 x H x W)
        input_img_arr[0:3, :, :] = norm_0.transpose(2, 0, 1)  # 3 x H x W
        input_img_arr[3:6, :, :] = norm_1.transpose(2, 0, 1)
        input_img_arr[6:9, :, :] = norm_2.transpose(2, 0, 1)
        input_img_arr[9:12, :, :] = norm_3.transpose(2, 0, 1)
